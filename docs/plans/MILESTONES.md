...
| **38** | Rollout runbook: phased enablement from a zero tab budget to sole route, in the order that never leaves traffic unarbitrated. **Includes the one-time sign-in, by hand, into the window already open — nothing stopped, nothing relaunched** | 37, 44 | `done` |
